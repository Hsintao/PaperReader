          ...
          <div className="modal-body profile-body">
            ...
            {tab === 'reading' && (
              <section className="profile-section borderless">
                <div className="settings-section-heading"><div><h3>界面设置</h3><p>这些偏好保存在本机数据目录。</p></div></div>
                <div className="field-grid two">
                  <label className="field"><span>主题</span><select value={reading.theme} onChange={(e) => setReading((v) => ({ ...v, theme: e.target.value as Theme }))}><option value="light">浅色</option><option value="gray">灰色</option><option value="dark">深色</option></select></label>
